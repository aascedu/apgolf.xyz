...
<style scoped>
.footer {
  font-family: 'Matangi', sans-serif; /* Apply Matanga font to the footer */
  word-spacing: 0.05em;
  margin-top: 8vw;
  background-color: oklch(52.7% 0.154 150.069); /* Updated to match the specified color */
  height: 25vw; /* 15% of the viewport width */
}
</style>